...
import { billColumns } from "@/components/ap/bill-columns"
...
export function BillsDataTable({ data, error }: BillsDataTableProps) {
    ...
    <div className="flex flex-col gap-4">
          ...
          <TableBody>
            {table.getRowModel().rows.length ? (
              ...
              <TableRow>
                ...
                >
                  No vendor bills yet. Create a bill to get started.
                </TableCell>
              </TableRow>
            )}
          </TableBody>
      ...
      <div className="flex items-center justify-between gap-3">
        <p className="text-sm text-muted-foreground">
          {table.getFilteredRowModel().rows.length} bill
